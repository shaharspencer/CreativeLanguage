...
class FillMask:
    ...
    def get_top_k_predictions(self, input_dataframe: pd.DataFrame,  tagger) \
        ...
        for index, row in input_dataframe.iterrows():
            replacements, pos_prediction = self.__predict_single_row(row, tagger)
    ...
    def __append_outputs_to_csv(self, input_dataframe,
        ...
        input_dataframe["ROBERTA REPLACEMENTS"] = pd.Series(replacement_word_predictions)
    ...
    """
    def __get_top_k_pos_predictions(self, replacements, sentence, index, tagger)->str:
