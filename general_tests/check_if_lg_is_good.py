...
def check_if_lg_is_as_good_as_trf(csv_path =
                                  r"C:\Users\User\PycharmProjects\CreativeLanguage\explore_verb_patterns\extract_creative_sentences\DepStruct\dependent_order_by_count_2023_01_01.csv"):
...
def output_to_dep_graph(sentence,):
    ...
    path = os.path.join(r"C:\Users\User\PycharmProjects\CreativeLanguage\general_tests\graph_dir",
                        sentence[:5] + ".svg")
